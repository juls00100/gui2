 ...
 * @author juls
 */
public class accadmin extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(accadmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
