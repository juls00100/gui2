...
public class logIn extends baseFrame {
    ...
    String em = emails.getText(); 
    String pew =passs.getText();   

    // Query to check if the user exists
    String query = "SELECT u_status FROM tbl_user WHERE u_email = '" + em + "' AND u_pass = '" + pew + "'";
    ...
    try {
        ...
        if (rs != null && rs.next()) {
            ...
            // VALIDATION: Check if status is Pending
